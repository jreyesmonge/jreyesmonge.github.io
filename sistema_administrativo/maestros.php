...
<body>
    ...
    server with default setting (user 'root' with no password) */
        ...
        $result = $conn->query("SELECT * FROM maestros");
    ?>
            ...
            <tbody>
                <?php while ($row = $result->fetch_array(MYSQLI_ASSOC)) { ?>
                    <tr>
                        ...
                        <td><a href="./maestros/modificar.php?id=<?php echo $row['id']; ?>"><span class="glyphicon glyphicon-pencil"></span></a></td>
                        <td><a href="#" data-href="./maestros/eliminar.php?id=<?php echo $row['id']; ?>" data-toggle="modal" data-target="#confirm-delete"><span class="glyphicon glyphicon-trash"></span></a></td>
                    </tr>
                <?php } 
                $conn->close()?>
            </tbody>
    ...
    <div class="contenedor" style="border-radius: 10px;">
        ...
        <form class="formulario" action="./maestros/insertar_maestro.php" method="POST">
